# I stole this code from: https://github.com/Mustache-Games/Godot-Interactive-Touchscreen-Button/tree/main
# Video showcase: https://www.youtube.com/watch?v=mdNc1ZAJQpM

# It substitutes the stupid ahh TouchScreenButtons that extend Node2D and cannot be anchored xdd

@icon("res://Assets/Sprites/interactive-touchscreen-button-icon.svg")
